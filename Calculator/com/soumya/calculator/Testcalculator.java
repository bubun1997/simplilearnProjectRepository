         ...
         first:while(true)
         {
            ...
            second:switch(choice)
            {
               case 1:
            	      ...
            	      System.out.println(calculatorObj.addNumbers(num1,num2));
            	      break first;
               case 2:
            	      System.out.print("Enter 1st Number : ");
	         	      ...
	         	      System.out.println(calculatorObj.subtractNumbers(num1,num2));
	         	      break first;
               case 3:
            	      System.out.print("Enter 1st Number : ");
	         	      num1=scannerObj.nextDouble();
	         	      System.out.print("Enter 2nd Number : ");
	         	      num2=scannerObj.nextDouble();
	         	      System.out.println(calculatorObj.multiplyNumbers(num1,num2));
	         	      break first;
               case 4:
         	          System.out.print("Enter 1st Number : ");
	         	      num1=scannerObj.nextDouble();
	         	      System.out.print("Enter 2nd Number : ");
	         	      num2=scannerObj.nextDouble();
	         	      System.out.println(calculatorObj.divideNumbers(num1,num2));
	         	      break first;
	         	default:continue;
